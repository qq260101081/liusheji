 ...
 *
 * @property integer $id
 * @property integer $warehouse_sea_id
 ...
 */
class WarehouseSeaLog extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['warehouse_sea_id', 'number', 'box_number'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'warehouse_sea_id' => 'Warehouse Sea ID',
            'series' => 'Series',
